  ...
  namespace detail
  {
                                            ...
                                            time_t usec)
    {
      ...
      if (poll_res > 0 && pfd_read.revents & (POLLIN | POLLOUT))
      {
        ...
        return successful ? Error::Success_ : Error::Connection;
      }
...
#define USE_IF2IP
                                   ...
                                   std::string &boundary) const
  {
    ...
    else
    {
      ...
      if (type != detail::EncodingType::None_)
      {
        std::unique_ptr<detail::compressor> compressor;
